...
export const ThisWeeksHoursWidget: React.FC = () => {
        ...
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            <Tooltip
              ...
              formatter={(value: number) => [`${value} hrs`, 'Hours Worked']}
              contentStyle={{
...
export default ThisWeeksHoursWidget;
